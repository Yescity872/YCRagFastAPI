...
class MiscBot:
    ...
    def _format(self, query: str, docs: List[Document]) -> str:
        ...
        prompt = f"""
You are a general travel assistant for {self.city.title()}. Use only context below. Provide concise helpful answer. If insufficient context, say 'Not enough data'.
...
"""
    ...
    def misc_bot(self, query: str, k: int = 2) -> Dict[str, Any]:
